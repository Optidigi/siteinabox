...
import {
  ...
  Ear, Edit, ExternalLink, Eye, File, FileText, Filter, Flag, Folder, Gift,
  Globe, Grid, Hash, Heart, HeartHandshake, Home, Image, Inbox, Info, Layers, Layout,
...
export const ICON_MAP: Record<string, LucideIcon> = {
  ...
  globe: Globe, grid: Grid, hash: Hash, heart: Heart,
