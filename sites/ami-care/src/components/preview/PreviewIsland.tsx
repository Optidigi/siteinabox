...
type Props = {
  ...
  // siab-payload routes both to the same Next.js admin app via Traefik and
...
function PreactBlock({
  ...
  if (block.blockType === "richText") {
    return <RichText body={block.body} anchor={block.anchor} dataBlockIndex={dataBlockIndex} analytics={block.analytics} />
  }
  ...
  if (block.blockType === "faq") {
    return (
      <FAQ title={block.title} items={block.items} anchor={block.anchor} dataBlockIndex={dataBlockIndex} analytics={block.analytics} />
    )
  }
