...
export const Tenants: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "domainVerification", type: "group",
      admin: { description: adminText("Domain verification evidence. Every enabled TLD workflow verifies active authoritative DNS before first publication.", "Bewijs van domeinverificatie. Elke ingeschakelde TLD-workflow verifieert actieve autoritatieve DNS vóór de eerste publicatie.") },
      fields: [
