    ...
    <div className="flex flex-col gap-3 rounded-md border p-3">
      ...
      {activePreviewUrl && (
        <div className="flex flex-col gap-2 md:flex-row">
          <Input value={activePreviewUrl} readOnly aria-label="Preview URL" className="font-mono text-xs" />
      ...
      {state.message && (
        <Alert variant={state.ok ? "default" : "destructive"}>
          <AlertTitle>{state.ok ? "Preview access sent" : "Preview access failed"}</AlertTitle>
