...
export const SITE_GENERATION_SYSTEM_PROMPT = [
  ...
  "Theme output must be ThemeTokenSpec V3 preset IDs only: colors blue-professional/red-confident/emerald-calm/amber-warm; fonts clear-modern/classic-editorial/friendly-organic; shape rounded/soft/sharp; mode light/dark/system.",
