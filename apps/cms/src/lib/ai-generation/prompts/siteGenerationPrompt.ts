...
export const SITE_GENERATION_SYSTEM_PROMPT = [
  ...
  "Theme output must be ThemeTokenSpec V3 preset IDs only: colors shadcn-neutral/blue-professional/red-confident/emerald-calm/amber-warm; fonts shadcn-geist/clear-modern/classic-editorial/friendly-organic; shape shadcn-default/rounded/soft/sharp; mode light/dark/system.",
  "Map explicit visual or intake style hints to the nearest approved theme preset. If unclear, use shadcn-neutral, shadcn-geist, shadcn-default, and light mode.",
