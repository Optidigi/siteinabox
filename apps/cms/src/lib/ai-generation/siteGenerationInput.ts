...
export const buildSiteGenerationModelInput = (
  ...
  requirements: [
    ...
    "Set theme only to approved ThemeTokenSpec V3 preset IDs: colors shadcn-neutral/blue-professional/red-confident/emerald-calm/amber-warm; fonts shadcn-geist/clear-modern/classic-editorial/friendly-organic; shape shadcn-default/rounded/soft/sharp; mode light/dark/system.",
