...
const genericSiteGenerationSpec: SiteGenerationSpec = {
          ...
          plans: [
            {
              ...
              description: blockText("Een eerste preview met structuur, tekst en contactmogelijkheid."),
              price: "Preview",
              period: "concept",
            ...
            {
              title: inlineText("Livegang"),
              description: blockText("Na akkoord volgen domein, betaling en gecontroleerde publicatie."),
              price: "Na akkoord",
              period: null,
              cta: { label: "Neem contact op", href: "/#contact" },
              features: [
                { label: inlineText("Publicatiegate"), included: true },
                { label: inlineText("Domeincontrole"), included: true },
                { label: inlineText("Betaling voor livegang"), included: true },
              ],
              badge: "Volgende stap",
              highlighted: true,
            },
  ...
  blocks: [
    ...
    { slug: "pricing", label: "Proces", defaultAnchor: "process" },
