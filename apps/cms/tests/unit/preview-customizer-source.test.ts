...
describe("preview customizer source contract", () => {
  it("hosts customer preview through an embedded renderer iframe contract", () => {
    ...
    expect(componentSource).toContain("h-12 border-0 bg-card/95 shadow-none")
    ...
    expect(componentSource).toContain("h-12 w-12 rounded-md px-0 md:w-auto md:px-5")
    expect(componentSource).toContain("h-12 rounded-md px-4 md:px-5")
