...
describe("preview customizer source contract", () => {
  it("hosts customer preview through an embedded renderer iframe contract", () => {
    ...
    expect(componentSource).toContain('className="pointer-events-none fixed inset-x-0 bottom-0 z-30 px-0 md:bottom-6 md:px-6"')
    ...
    expect(componentSource).toContain("md:mx-auto md:max-w-4xl md:rounded-lg md:border-0 md:bg-background/90")
