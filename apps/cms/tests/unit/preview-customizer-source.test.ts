...
describe("preview customizer source contract", () => {
  it("hosts customer preview through an embedded renderer iframe contract", () => {
    ...
    expect(componentSource).toContain("pointer-events-auto grid w-full grid-cols-[1fr_auto_1fr] items-center gap-1")
    ...
    expect(componentSource).toContain("md:px-3 md:py-2")
    expect(componentSource).toContain("md:rounded-lg md:border-0 md:bg-background/90")
    expect(componentSource).toContain('<span className="md:hidden" aria-hidden />')
