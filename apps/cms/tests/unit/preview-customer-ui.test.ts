...
describe("customer preview UI", () => {
  ...
  it("renders checkout as an accessible three-step authoritative-profile flow", () => {
    ...
    expect(checkout).toContain('type CheckoutStep = "domain" | "details" | "overview"')
    ...
    expect(checkout).toContain('id: "details"')
    expect(checkout).toContain('id: "overview"')
    ...
    expect(checkout).toContain("h-10 pr-11 pl-9 text-sm font-medium")
    expect(checkout).toContain('Card data-checkout-main-card className="gap-0 overflow-hidden py-0 shadow-xs"')
    expect(checkout).toContain('CardHeader className="flex-row items-center gap-2.5 border-b bg-muted/20')
    expect(checkout).toContain("focus-visible:border-success")
    expect(checkout).toContain("size-5 text-success")
    expect(stepper).toContain('active && "bg-card text-foreground shadow-xs"')
    expect(stepper).toContain('complete && "text-foreground"')
    expect(stepper).toContain('rounded-[calc(var(--radius)-2px)]')
