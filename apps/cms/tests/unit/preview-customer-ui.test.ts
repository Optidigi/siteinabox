...
describe("customer preview UI", () => {
  it("uses a dedicated customer preview canvas mode without editor metadata badges", () => {
    ...
    expect(customizer).toContain("h-12 w-12 rounded-md px-0 md:w-auto md:px-5")
    expect(customizer).toContain("h-12 rounded-md px-4 md:px-5")
    ...
    expect(customizer).toContain("h-12 border-0 bg-card/95 shadow-none")
