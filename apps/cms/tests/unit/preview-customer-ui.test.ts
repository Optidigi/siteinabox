...
describe("customer preview UI", () => {
  ...
  it("renders checkout as an accessible three-step authoritative-profile flow", () => {
    ...
    expect(checkout).toContain("h-11 pr-11 pl-9 text-sm font-medium sm:text-base")
    expect(checkout).toContain('CardDescription className="max-w-2xl text-sm leading-relaxed"')
