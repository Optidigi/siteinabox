...
describe("customer preview UI", () => {
  ...
  it("renders checkout as a branded two-step flow with domain fee states", () => {
    ...
    expect(checkout).toContain("suggestDomainAlternativesAction")
    expect(checkout).toContain("suggestionsFormRef")
    ...
    expect(page).toContain("suggestPreviewCheckoutDomainsAction")
