...
describe("customer preview UI", () => {
  it("uses a dedicated customer preview canvas mode without editor metadata badges", () => {
    ...
    expect(customizer).toContain("mx-auto grid w-fit grid-cols-[auto_auto_auto] items-center gap-1")
    expect(customizer).toContain('role="group" aria-label={t("themeControls")}')
