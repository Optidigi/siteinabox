...
describe("customer preview UI", () => {
  it("uses a dedicated customer preview canvas mode without editor metadata badges", () => {
    ...
    expect(customizer).toContain("size-12 justify-self-start rounded-md md:h-12 md:w-auto md:px-5")
    expect(customizer).toContain("h-12 justify-self-end")
    expect(customizer).toContain("justify-self-start")
