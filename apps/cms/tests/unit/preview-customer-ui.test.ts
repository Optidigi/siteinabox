...
describe("customer preview UI", () => {
  it("uses a dedicated customer preview canvas mode without editor metadata badges", () => {
    ...
    expect(customizer).toContain("onShuffleTheme")
    expect(customizer).toContain("onDefaultTheme")
    expect(customizer).toContain("PREVIEW_RANDOM_MODES")
    expect(customizer).toContain("DEFAULT_THEME_TOKEN_SPEC")
    ...
    expect(customizer).toContain("PalettePicker")
    expect(customizer).toContain("FontPicker")
    expect(customizer).toContain("ShapeControl")
    expect(customizer).toContain("DensityControl")
    ...
    expect(customizer).toContain("md:inline-flex md:w-auto md:grid-cols-none md:justify-center md:gap-2")
    ...
    expect(customizer).toContain("flex justify-self-end items-center gap-2")
    expect(customizer).toContain("h-12 w-12 rounded-md px-0 md:h-9 md:w-auto md:px-5")
    expect(customizer).toContain("h-12 rounded-md px-4 md:h-9 md:px-5")
    expect(customizer).toContain("justify-self-center")
    ...
    expect(customizer).toContain('md:not-sr-only md:ml-2">{t("reviewChanges")}')
    expect(customizer).toContain("h-12 border-0 bg-card/95 shadow-none md:h-9")
    ...
    expect(customizer).toContain('className="w-full pb-24 md:pb-32"')
