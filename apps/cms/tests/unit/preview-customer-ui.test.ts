...
describe("customer preview UI", () => {
  ...
  it("renders checkout as an accessible two-decision authoritative-profile flow", () => {
    ...
    expect(checkout).toContain("h-12 rounded-xl pr-11 pl-10 text-base font-medium")
    ...
    expect(stepper).toContain("rounded-xl border bg-card/70")
    ...
    expect(checkout).not.toContain("<X")
