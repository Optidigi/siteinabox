...
describe("mobile inspector snap contract", () => {
  ...
  it("keeps mobile section navigation and save affordances pill-shaped", () => {
    ...
    expect(frameEditor).toContain('className="-mx-4 flex min-h-[calc(100dvh-4.5rem)] flex-col"')
    ...
    expect(frameEditor).toContain('className="sticky top-0 z-30 flex min-w-0 items-center justify-center border-b border-border bg-background px-16 py-3"')
