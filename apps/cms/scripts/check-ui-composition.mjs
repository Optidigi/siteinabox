...
const ALLOWED_NATIVE_BUTTON_FILES = new Set([
  ...
  "src/components/editor/canvas/blocks/Testimonials.tsx",
  "src/components/editor/canvas/chrome/block-gutter.tsx",
  "src/components/editor/canvas/chrome/block-type-picker.tsx",
  "src/components/editor/canvas/chrome/canvas-gap-button.tsx",
  "src/components/editor/canvas/inline/InlineCtaButton.tsx",
  "src/components/editor/canvas/inline/InlineIcon.tsx",
  "src/components/editor/canvas/inline/InlineImage.tsx",
  "src/components/editor/canvas/mobile/mobile-array-drilldown.tsx",
  "src/components/editor/canvas/mobile/mobile-component-editor.tsx",
  "src/components/editor/canvas/mobile/mobile-icon-sheet.tsx",
  "src/components/editor/canvas/mobile/mobile-section-list.tsx",
  ...
  "src/components/editor/richText/toolbar/color-chip.tsx",
