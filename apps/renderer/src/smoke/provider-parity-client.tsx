...
const Component = props.kind === "reference" ? ShadcnUiPinnedLiteralReference : props.kind === "chrome" ? ShadcnUiChromeView : props.kind === "system" ? ShadcnUiNotFoundView : ShadcnUiExplicitBlockView
