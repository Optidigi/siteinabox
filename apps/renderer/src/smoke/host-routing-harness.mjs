...
export async function assertHostRouting(baseUrl, failureContext = "", { includeMalformedEncodedPath = true } = {}) {
  ...
  assert.match(amicareHtml, /--siab-font-display:Fraunces Variable, ui-serif, Georgia, Cambria, "Times New Roman", Times, serif/)
  assert.match(amicareHtml, /--font-title:var\(--siab-font-display\)/)
