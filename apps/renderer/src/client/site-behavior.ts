...
import { initializeHeroDitherEffects } from "@siteinabox/site-renderer/hero-dither-effect"
import {
...
initializeHeroDitherEffects(document)
void initializeHeroAmbientEffectsWhenPresent(document)
