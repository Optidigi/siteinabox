...
import type { HeroBlock, MediaRef } from "@siteinabox/contracts"
...
const defaultImage: Exclude<MediaRef, null> = {
...
export function TailwindPlusMarketingHeroWithStatsRenderer({
  block,
  options,
}: {
  block: HeroBlock
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          {(block.subheadline || options.editSlots?.renderRichText) && (
            <div className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
              {richTextSlot({
                options,
