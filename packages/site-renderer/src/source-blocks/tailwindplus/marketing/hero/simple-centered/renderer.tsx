  ...
  return (
    <section {...sectionProps}>
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="siab-source-clip-tailwindplus-glow relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
        ...
        >
          <div
            className="siab-source-clip-tailwindplus-glow relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-288.75"
            data-siab-tokenized-gradient="hero-glow"
            style={{ clipPath: gradientClipPath }}
          />
        </div>
