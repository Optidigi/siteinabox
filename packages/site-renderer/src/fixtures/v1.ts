...
export const v1FixturePage: Page = {
  ...
  blocks: [
    ...
    { blockType: "appointments", variant: "appointments-01", presentation: "inline", backgroundMode: "none", image: { url: "/fixture-media/project-office.webp", alt: "Lichte kantoorruimte met glazen wanden en werkplekken", width: 1402, height: 1122 }, heading: "Plan een rustig moment", body: "Kies een moment dat past en vertel kort waar je hulp bij zoekt.", availabilityLabel: "Beschikbaarheid", bookingLabel: "Afspraak aanvragen", confirmationHeading: "Afspraak bevestigd", confirmationBody: "Je ontvangt zo een bevestiging met de details van je afspraak.", privacyNote: "We gebruiken je gegevens alleen om deze afspraak te behandelen.", anchor: "appointments" },
