...
export const contact01Items = [
  contactItem(
    ...
    "mail",
    "mailto:akashmoradiya3444@gmail.com",
  ),
  contactItem(
    "Office",
    ...
    "map-pin",
    "about:blank#upstream-contact-office",
  ),
  contactItem(
    "Phone",
...
export const contactFamilyCmsLike = {
  ...
  description: previewInlineText("Our friendly team is always here to chat"),
...
export const contact02CmsLike = {
  ...
  description: previewInlineText("We'd love to hear from you. Please fill out this form or shoot us an email."),
  formName: "Contact Us",
  submitLabel: "Submit",
  fields: [
    { name: "firstName", label: "First Name", type: "text" as const, placeholder: "First name" },
    { name: "lastName", label: "Last Name", type: "text" as const, placeholder: "Last name" },
    ...
    { name: "acceptTerms", label: "You agree to our terms and conditions.", type: "checkbox" as const },
  ],
}
