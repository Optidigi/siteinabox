// Owned typed adaptation of upstream shadcnui-blocks testimonials-12 (MIT, see ../../LICENSE).
...
export type Testimonials12Props = TypedVariantBaseProps & {
  title?: string | null
  intro?: string | null
        ...
        {displayItems.map((item, itemIndex) => {
          ...
          return (
            <div
              ...
              key={itemIndex}
            >
              <span className="absolute top-0 left-4 select-none font-satoshi text-9xl text-foreground/20">&ldquo;</span>
...
export default function Testimonials12Literal() {
  return (
    <Testimonials12
      title="What Our Customers Say"
      intro="Real feedback from real users who trust our platform"
      items={LITERAL_ITEMS}
