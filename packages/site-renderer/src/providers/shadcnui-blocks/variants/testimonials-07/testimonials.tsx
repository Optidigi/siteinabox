// Owned typed adaptation of upstream shadcnui-blocks testimonials-07 (MIT, see ../../LICENSE).
...
export type Testimonials07Props = TypedVariantBaseProps & {
  title?: string | null
  intro?: string | null
      ...
      <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {displayItems.map((item, itemIndex) => {
          ...
          return (
            ...
            >
              {quoteContent ? (
                <p className="grow rounded-t-lg px-5 py-6 font-medium text-lg">{quoteContent}</p>
              ) : null}
              <Separator />
...
export default function Testimonials07Literal() {
  return (
    <Testimonials07
