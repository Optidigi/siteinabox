...
import { logoCloud11Literal, logoCloudFamilyCmsLike } from "../../typed/fixtures/logo-cloud-family"
...
export default function LogoCloud11Literal() {
  return <LogoCloud11 intro={logoCloud11Literal.intro} logos={logoCloudFamilyCmsLike.logos} blockIndex={0} literalPreview />
}
