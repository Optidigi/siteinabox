...
const Features = () => {
  return (
    <div className="mx-auto w-full max-w-(--breakpoint-lg) px-6 py-20">
      <h2 className="font-medium text-3xl leading-10 tracking-[-0.04em] sm:text-4xl md:text-[40px] md:leading-13"><ProviderField field="eyebrow" fallback={<>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-3">
        ...
        <div className="col-span-1 rounded-xl bg-muted p-6 md:col-span-2 lg:col-span-1">
          ...
          <ul className="mt-6 space-y-5">
            <li>
              <div className="flex items-start gap-3"><ProviderField field="intro" fallback={<>
          ...
          <ProviderDemoOnly fallback={<><Button className="mt-8 w-full">
