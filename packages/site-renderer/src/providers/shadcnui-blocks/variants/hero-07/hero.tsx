// Owned typed adaptation of upstream shadcnui-blocks hero-07 (MIT, see ../../LICENSE).
"use client"
...
export type Hero07Props = TypedVariantBaseProps & {
  eyebrow?: RtRoot | null
  headline: RtRoot
...
export function Hero07({
  ...
  rootAttributes,
  ...rest
}: Hero07Props & React.HTMLAttributes<HTMLDivElement>) {
...
export default function Hero07Literal() {
  return (
    <Hero07
