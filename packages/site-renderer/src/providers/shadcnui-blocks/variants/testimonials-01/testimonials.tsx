// Owned typed adaptation of upstream shadcnui-blocks testimonials-01 (MIT, see ../../LICENSE).
"use client"
...
export type Testimonials01Props = TypedVariantBaseProps & {
  title?: string | null
  intro?: string | null
...
export default function Testimonials01Literal() {
  return (
    <Testimonials01
      title={testimonials01Literal.title}
      intro={testimonials01Literal.intro}
