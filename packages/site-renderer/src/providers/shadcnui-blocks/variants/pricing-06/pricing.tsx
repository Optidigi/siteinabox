// Owned typed adaptation of upstream shadcnui-blocks pricing-06 (MIT, see ../../LICENSE).
"use client"
...
export type Pricing06Props = TypedVariantBaseProps & {
  title?: RtRoot | null
  intro?: RtRoot | null
  plans: PricingPlanItem[]
}

export function Pricing06({ title, intro, plans, blockIndex, editSlots, rootAttributes }: Pricing06Props) {
...
export default function Pricing06Literal() {
  return (
    <Pricing06
