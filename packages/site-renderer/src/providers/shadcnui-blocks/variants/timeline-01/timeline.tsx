// Owned typed adaptation of upstream shadcnui-blocks timeline-01 (MIT, see ../../LICENSE).
"use client"
...
export type Timeline01Props = TypedVariantBaseProps & {
  items: TimelineItem[]
}

export function Timeline01({ items, blockIndex, editSlots, rootAttributes }: Timeline01Props) {
...
export default function Timeline01Literal() {
  return <Timeline01 items={timeline01Literal.items} blockIndex={0} />
}
