...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto inline-flex max-w-fit flex-row items-center justify-center overflow-hidden font-medium backdrop-blur transition-shadow duration-500 ${showBorder ? "px-2 py-1" : ""} ${className}`}
