    ...
    <div className="px-6 py-12">
      <div className="mx-auto mt-10 grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
        <div className="flex flex-col rounded-xl bg-muted p-5 max-sm:col-span-full sm:row-span-3">
          <p className="mb-8 max-w-[20ch] text-balance font-medium text-2xl tracking-tight sm:text-xl lg:text-2xl"><ProviderField field="title" fallback={<>
            Trusted by teams and companies around the world
          </>} inline /></p>

          <Button className="mt-auto max-sm:me-auto" size="lg" asChild><ProviderAction field="cta" fallback={"View companies"} decoration="after"><ArrowUpRight /></ProviderAction></Button>
        </div>
