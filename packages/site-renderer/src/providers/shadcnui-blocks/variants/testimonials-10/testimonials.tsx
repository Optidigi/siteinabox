// Owned typed adaptation of upstream shadcnui-blocks testimonials-10 (MIT, see ../../LICENSE).
...
export type Testimonials10Props = TypedVariantBaseProps & {
  title?: string | null
  intro?: string | null
              ...
              <div className="relative flex flex-col rounded-md border bg-linear-to-bl from-muted/50 via-background to-background px-5 pt-10 pb-3 dark:border-muted-foreground/30 dark:bg-background border-border">
                ...
                <div className="mt-2 flex items-center gap-3 py-3.5 sm:mt-4">
                  {renderTestimonialAvatarImage(
                    ...
                    {
                      className:
                        "h-12 w-12 rounded-full ring-2 ring-border ring-offset-[2px] ring-offset-background",
                      height: 48,
                      width: 48,
...
export default function Testimonials10Literal() {
  return (
    <Testimonials10
