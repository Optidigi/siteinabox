...
const features = [
  {
    ...
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:85f35",
  },
  {
    icon: BookCheck,
    title: "Build Authority",
    description: "Create valuable content that resonates and inspires trust.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:d30fc",
  },
  {
    icon: ChartPie,
    title: "Instant Insights",
    description: "Gain immediate, actionable insights with a quick glance.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:07ff9",
  },
  {
    icon: Users,
    title: "Engage with Your Audience",
    description: "Boost audience engagement with interactive features.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:c1427",
  },
  {
    icon: FolderSync,
    title: "Automate Your Workflow",
    description: "Streamline your processes by automating repetitive tasks.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:1218e",
  },
  {
    icon: Zap,
    title: "Accelerate Growth",
    description: "Supercharge your growth by implementing strategies.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:003d6",
  },
  {
    icon: BookCheck,
    title: "Build Authority",
    description: "Create valuable content that resonates and inspires trust.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:80189",
  },
  {
    icon: ChartPie,
    title: "Instant Insights",
    description: "Gain immediate, actionable insights with a quick glance.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:19eb3",
  },
  {
    icon: Goal,
    title: "Identify Opportunities",
    description:
      "Easily uncover untapped areas to explore and expand your reach.",
    image: "data:image/gif;base64,R0lGODlhAQABAAAAACw=#sha256:ca3a0",
  },
];
