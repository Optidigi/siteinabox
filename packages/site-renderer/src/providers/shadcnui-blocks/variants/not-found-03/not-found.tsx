    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden items-center justify-center overflow-hidden border-border/70 bg-neutral-950 lg:flex dark:border-s">
        ...
        <div className="relative flex items-center gap-2 *:size-32">
          <Number4 idPrefix="provider-404-first" />
          <Number0 />
          <Number4 idPrefix="provider-404-second" />
        </div>
      </div>
    </div>
  );
...
// Generated from about:blank#upstream-sha256:09f0e by realvjy
export const Number4 = ({ idPrefix = "provider-404", ...props }: SVGProps<SVGSVGElement> & { idPrefix?: string }) => (
  ...
  >
    ...
    <g mask={`url(#${idPrefix}-mask)`} style={{ mixBlendMode: "overlay" }}>
      <path
        d="M200 0H0v200h200V0z"
        fill="gray"
        filter={`url(#${idPrefix}-noise)`}
        stroke="transparent"
      />
    </g>
    <defs>
