// Owned typed adaptation of upstream shadcnui-blocks testimonials-06 (MIT, see ../../LICENSE).
"use client"
...
import { testimonials06CmsLike } from "../../typed/fixtures/testimonials-family"
...
const LITERAL_ITEMS: TestimonialItem[] = [
  {
    ...
    quote:
      "This product has completely transformed the way we work. The efficiency and ease of use are unmatched! We were struggling with productivity before, but this tool has streamlined our entire process. ",
  },
  {
    author: "Jane Smith",
  ...
  },
  {
    ...
    role: "UX Designer",
    quote:
      "The user experience is top-notch! The interface is clean, intuitive, and easy to navigate. As a designer, I appreciate the attention to detail and well-thought-out UI components. It makes designing and prototyping so much more efficient.",
  },
  {
    author: "James Mitchell",
    role: "Marketing Specialist",
    quote:
      "I've seen a significant improvement in our team's productivity since we started using this service. The ability to track performance, analyze data, and collaborate across teams has been a game-changer.",
  },
  {
    author: "Daniel Martinez",
    role: "Full-Stack Developer",
    quote:
      "The best investment we've made! The support team is also super responsive and helpful. As a developer, I appreciate the well-documented API, the flexibility of integrations, and the robust security features.",
  },
  {
    author: "Sophia Lee",
    role: "Data Analyst",
    quote:
      "This tool has saved me hours of work! The analytics and reporting features are incredibly powerful. I can now generate detailed reports in minutes, which previously took days to compile. helping us make smarter, data-backed decisions.",
  },
]
...
export type Testimonials06Props = TypedVariantBaseProps & {
  title?: string | null
  intro?: string | null
...
function TestimonialCard({
  ...
  itemIndex: number
  blockIndex: number
  editSlots?: Testimonials06Props["editSlots"]
  mediaResolver?: MediaResolver
  literalPreviewImages?: string[]
}) {
  ...
  const portraitImage = renderTestimonialAvatarImage(
    editSlots,
    mediaResolver,
    item.avatar,
    item.author,
    ...
    <div className="mb-8 rounded-xl bg-accent px-6 py-8 sm:py-6">
      <div className="flex items-center justify-between gap-20">
        <div className="relative hidden aspect-3/4 w-full max-w-[18rem] shrink-0 lg:block">
          <div className="absolute inset-0 overflow-hidden rounded-xl">{portraitImage}</div>
        ...
        <div className="flex flex-col justify-center">
          <div className="flex items-center justify-between gap-1">
            <div className="hidden items-center gap-4 sm:flex md:hidden">
              ...
              <div>
                {authorContent ? <p className="font-semibold text-lg">{authorContent}</p> : null}
...
export default function Testimonials06Literal() {
  return (
    <Testimonials06
      title={testimonials06CmsLike.title}
      intro={testimonials06CmsLike.intro}
      items={LITERAL_ITEMS}
