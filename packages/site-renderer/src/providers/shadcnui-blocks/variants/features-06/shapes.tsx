// Owned coolshape icons from upstream features-06 (MIT, see ../../LICENSE).
...
export function Flower10(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function Moon12(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function Triangle14(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
