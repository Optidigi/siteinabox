...
export const COMMERCE_RELEASE_EVIDENCE_VERSION =
  "commerce-production-readiness-2026-07-30.1" as const
...
export const domainMigrationStateTransitions = {
  ...
  awaiting_provider: ["awaiting_customer", "ready_for_cutover", "paused_supplemental_order", "custom_quote_required", "failed"],
  ready_for_cutover: ["awaiting_customer", "awaiting_provider", "cutover_in_progress", "paused_supplemental_order", "custom_quote_required", "failed"],
