...
export const SITE_SETTING_DISPOSITIONS = [
  ...
  { path: "systemTemplates.notFound.variant", disposition: "runtime", consumer: "fail-closed provider 404 template registry" },
  { path: "maintenance", disposition: "runtime", consumer: "approved provider maintenance banner adapter" },
